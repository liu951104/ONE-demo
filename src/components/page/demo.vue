<template>
  <div class="">
    <div  v-masonry transition-duration="0.3s" item-selector=".list-box" column-width=".list-box" id="box">
      <div class="list-box" v-masonry-tile v-for="detail in List" @click="toDetail(detail.item_id,detail.id)">
